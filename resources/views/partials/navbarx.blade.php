  ...
  <div class="navbar-collapse collapse">
    <ul class="navbar-nav navbar-align">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link nav-icon dropdown-toggle" href="#" id="alertsDropdown"
      ...
      {{-- Messages --}}
      <li class="nav-item dropdown">
        <a class="nav-link nav-icon dropdown-toggle" href="#" id="messagesDropdown"
           role="button" data-bs-toggle="dropdown" aria-expanded="false">
          <div class="position-relative">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="messagesDropdown">
          ...
          <div class="list-group">
            <a href="#" class="list-group-item">
              <div class="row g-0 align-items-center">
                <div class="col-2">
                  <img src="{{ asset('assets/adminkit/img/avatars/avatar-5.jpg') }}"
            ...
            <a href="#" class="list-group-item">
              <div class="row g-0 align-items-center">
                <div class="col-2">
                  <img src="{{ asset('assets/adminkit/img/avatars/avatar-2.jpg') }}"
      ...
      {{-- User --}}
      <li class="nav-item dropdown">
        <a class="nav-link nav-icon dropdown-toggle d-inline-block d-sm-none" href="#"
           role="button" data-bs-toggle="dropdown" aria-expanded="false">
